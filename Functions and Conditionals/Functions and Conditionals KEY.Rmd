...
```{r}
for(i in 1:length(trees_data$Height)){
  if(trees_data$Height[i]> 73){
    trees_data$Description[i]<- "tall"}
  else{
    trees_data$Description[i]<- "short"}
}
...
Make your own star sign generator!

```{r}
#for this example you will put in your birth month and get your star sign
...
Now, let's apply this to our tree dataset!
```{r}
#View(trees) #a quick visual of our dataset
library(dplyr)
