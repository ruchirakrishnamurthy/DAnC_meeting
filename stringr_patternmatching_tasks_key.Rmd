...
```{r}
#wordle example
str_subset(words, "[ast]")
```


let's practice detect and subset on a new string set of common names
```{r}
strings2 <- c("joseph", "jt", "michael", "ruchira", "mary", "alex", "jessica", "andrea", "joe", "stella", "bella")


names <- "a"

#What could I use if I wanted to know if there were any names with 'a' in them?
str_detect(strings2, names)
#what could I use if I wanted a list of names with a in them?
str_subset(strings2, names)
```
...
#try it with our original phone number example!
...
str_replace_all(strings, phone, "XXX-XXX-XXX")


#replacing all the 'a's with 'e's 
str_replace_all(strings2, names, "e")
